...
const LICHUNFENGS = [
    { liushen: '大安', liushou: '青龙', wuxing: '阳木', title: '长期，缓慢，稳定', detail: '求安稳，大安最吉；求变化，大安不吉' },
    { liushen: '留连', liushou: '四方', wuxing: '阴土', title: '停止，反复，复杂', detail: '想挽留，留连是吉；否则都很恶心' },
    { liushen: '速喜', liushou: '朱雀', wuxing: '阳火', title: '惊喜，快速，突然', detail: '意想不到的好事' },
    { liushen: '赤口', liushou: '白虎', wuxing: '阳金', title: '争斗，凶恶，伤害', detail: '吵架，打架，斗争，诉讼是非，肉体受伤，尤其赤口叠现' },
    { liushen: '小吉', liushou: '玄武', wuxing: '阳水', title: '起步，不多，尚可', detail: '成中有缺，适合起步' },
    { liushen: '空亡', liushou: '勾陈', wuxing: '阳土', title: '失去，虚伪，空想', detail: '先得再失，尤忌金钱事，可多接触玄学，哲学，心理学' }
]
...
module.exports = { LICHUNFENGS, JIUGONGS }